...
/**
  @class SU2_PionPdfDecomposition 

  @brief A class for pdf decomposition for the pion with SU2-symmetric sea
  ...
  */
namespace xfitter{
class SU2_PionPdfDecomposition:public BasePdfDecomposition{
  public:
    SU2_PionPdfDecomposition(const char*name);
