...
/**
  @class GRV_sea_PdfParam 

  @brief A class for GRV_sea pdf parameterisation
...
namespace xfitter{
class GRV_sea_PdfParam:public BasePdfParam{
 public:
  GRV_sea_PdfParam(const std::string&inName):BasePdfParam(inName){}
